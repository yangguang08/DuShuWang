<%@ Page Language="C#" MasterPageFile="~/tangshi/Tangshi.Master" AutoEventWireup="true" CodeBehind="xunxishan.aspx.cs" Inherits="ShuXiangShuiNing.tangshi.WebForm4" Title="无标题页" %>
...
<div id="container">
        ...
        <br />
        <div>
        <p class="author">作者：邱为</p>
        <p class="shiju">绝顶一茅茨，直上三十里。<br />
扣关无僮仆，窥室惟案几。<br />
若非巾柴车？应是钓秋水。<br />
差池不相见，黾勉空仰止。<br />
草色新雨中，松声晚窗里。<br />
